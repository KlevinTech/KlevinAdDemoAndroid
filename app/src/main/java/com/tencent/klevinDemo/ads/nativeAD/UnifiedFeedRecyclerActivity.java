...
import com.tencent.klevinDemo.view.LoadMoreRecyclerView;
...
public class UnifiedFeedRecyclerActivity extends BaseADActivity {
    private static final String TAG = ConfigConsts.DEMO_TAG + "FeedRecycler";

    private Spinner mAutoDownloadSpinner;
    private View mListLoadBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unified_feed_recycler);
    ...
    private void initViews() {
        ...
        mListLoadBtn = findViewById(R.id.btn_load);
        mListLoadBtn.setOnClickListener(v -> loadAdInfo());
        ...
        mRecyclerView.setLoadMoreListener(this::loadAdInfo);
    }
        ...
        if (getAdCount() <= 2) {
            ...
            NativeAd.load(builder.build(), new NativeAd.NativeAdLoadListener() {
                ...
                public void onAdLoadError(int err, String msg) {
                    ...
                    Toast.makeText(UnifiedFeedRecyclerActivity.this, "err: " + err + " " + msg, Toast.LENGTH_SHORT).show();
                }
            ...
            mListLoadBtn.setVisibility(View.GONE);
    ...
    private static class MyAdapter extends RecyclerView.Adapter<MyAdapter.AdViewHolder> {
        ...
        private static final int FILLING_ITEM_COUNT = 30;
        ...
        public void addData(List<NativeAd> ads) {
            for (int i = 0; i < FILLING_ITEM_COUNT; i++) {
                mData.add(null);
            }
            int count = mData.size();
            for (NativeAd ad : ads) {
                int random = (int) (Math.random() * FILLING_ITEM_COUNT) + count - FILLING_ITEM_COUNT;
                mData.set(random, ad);
            }
        ...
        public AdViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            switch (viewType) {
                case ITEM_VIEW_TYPE_LOAD_MORE:
                    return new LoadMoreViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_load_more_view, parent, false));
                case ITEM_VIEW_TYPE_VIDEO:
                    return new VideoAdViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_video_view, parent, false));
        ...
        public void onBindViewHolder(@NonNull AdViewHolder holder, int position) {
            if (holder instanceof VideoAdViewHolder) {
                ...
                videoAdViewHolder.videoContainer.post(() -> {
                    ...
                    UIUtils.setViewSize(videoAdViewHolder.videoContainer, width, (int) (width / (videoWidth / (double) videoHeight)) + 1);
                });
        ...
        public int getItemCount() {
            return mData.size() + FOOTER_VIEW_COUNT;
        }
        ...
        private void bindDownloadListener(final AdViewHolder adViewHolder, final View adView, NativeAd ad) {
        ...
        private static class LoadMoreViewHolder extends AdViewHolder {
            TextView mTextView;
            ...
            public LoadMoreViewHolder(View itemView) {
                ...
                mProgressBar = itemView.findViewById(R.id.progress_load_more);
            }
        }
